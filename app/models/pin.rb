class Pin < ActiveRecord::Base
	...
	validates_attachment_content_type :image, :content_type => ['image/jpeg', 'image/png'], :message => "Unidentified format, must be jpg, png"
	...
	has_attached_file :thum, :styles => { :medium => "300x300>", :thum => "100x100>" }
	validates_attachment_content_type :thum, :content_type => ['image/jpeg', 'image/png'], :message => "Unidentified format, must be jpg, png"
